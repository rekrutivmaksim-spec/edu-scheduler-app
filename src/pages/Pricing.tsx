...
const PREMIUM_FEATURES = [
  ...
  { icon: '📸', text: 'Безлимитные фото-решения задач' },
  { icon: '🎙️', text: 'Безлимитные аудио-вопросы' },
  { icon: '📚', text: 'Безлимитные занятия и материалы' },
...
const FAQ = [
  {
    ...
    a: 'Бесплатно: 3 вопроса к ИИ в день + 1 фото. Premium (499 ₽/мес) — безлимитный доступ ко всему: вопросы, фото, аудио, занятия, материалы.',
  },
  {
    q: 'Что входит в бесплатный доступ?',
    a: '3 вопроса к ИИ в день, 1 фото-решение. Для полного доступа ко всем функциям — оформи подписку Premium.',
  },
  {
