...
const FAQ_ITEMS = [
  ...
  { q: 'Что будет после окончания?', a: 'Базовые функции остаются: 3 вопроса к ИИ в день, 1 фото и 1 аудио. Premium — безлимит: вопросы, фото, аудио, занятия и материалы без ограничений.' },
];
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                {isPremium
                  ? 'Бонусные вопросы — не сгорают, накапливаются'
