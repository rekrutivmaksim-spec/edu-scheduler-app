...
const FAQ_ITEMS = [
  ...
  { q: 'Что будет после окончания?', a: 'Базовые функции остаются: 3 вопроса к ИИ в день и 1 фото. Premium — безлимит: вопросы, фото, аудио, занятия и материалы без ограничений.' },
];
