...
const FAQ = [
  {
    ...
    a: "Да! Базовые функции бесплатны: 3 вопроса к ИИ в день, занятия по ЕГЭ/ОГЭ, помодоро-таймер и геймификация. Premium открывает 20 вопросов/день и расширенные возможности.",
  },
  {
    q: "Для кого подходит?",
