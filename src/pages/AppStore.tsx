...
const FAQ = [
  {
    ...
    a: "Да! Базовые функции полностью бесплатны: расписание, задачи, зачётная книжка и 5 вопросов ИИ-ассистенту в день. Premium открывает 20 вопросов в день и расширенные функции.",
  },
  {
