...
const FEATURES = [
  {
    ...
    desc: "Задавай вопросы по любому предмету — ИИ объяснит тему, решит задачу и разберёт ошибки.",
  },
  {
    icon: "GraduationCap",
    title: "Подготовка к ЕГЭ/ОГЭ",
    desc: "Ежедневные занятия по выбранному предмету, пробные тесты, калькулятор баллов и подбор вузов.",
  },
  {
    icon: "Timer",
    title: "Помодоро-таймер",
    desc: "Учись по методу Помодоро с трекером сессий, статистикой и системой стриков.",
  },
  {
    icon: "FileText",
    title: "Анализ файлов",
    desc: "Загрузи PDF, DOCX или TXT — ИИ извлечёт ключевые идеи, создаст конспект и карточки для запоминания.",
  },
  {
    icon: "Trophy",
    title: "Геймификация",
    desc: "Зарабатывай XP, выполняй ежедневные квесты, поддерживай стрик и соревнуйся в рейтинге.",
  },
  {
    icon: "Camera",
    title: "Фото-решение",
    desc: "Сфотографируй задачу — ИИ распознает текст и покажет пошаговое решение.",
  },
];
...
const REVIEWS = [
  {
    ...
    uni: "11 класс, ЕГЭ",
    stars: 5,
    text: "ИИ-ассистент объясняет темы понятнее, чем учебник. Помог разобраться в химии!",
  },
  {
    name: "Дмитрий Л.",
    uni: "Студент, 2 курс",
    stars: 5,
    text: "Помодоро-таймер и стрики помогли перестать прокрастинировать. Занимаюсь каждый день!",
  },
  {
    name: "Мария С.",
    uni: "9 класс, ОГЭ",
    stars: 4,
    text: "Готовлюсь к ОГЭ по математике. Очень удобно — всё в одном месте.",
  },
];
...
const FAQ = [
  {
    ...
    a: "Да! Базовые функции бесплатны: от 3 до 10 вопросов к ИИ в день, занятия по ЕГЭ/ОГЭ, помодоро-таймер и геймификация. Premium открывает 20 вопросов/день и расширенные возможности.",
  },
  {
    q: "Для кого подходит?",
    a: "Для школьников (ЕГЭ/ОГЭ) и студентов. Выбирайте предмет, загружайте конспекты и готовьтесь с ИИ-помощником.",
  },
  {
  ...
  },
  {
    ...
    a: "Конечно. Мы не передаём персональные данные третьим лицам. Оплата проходит через защищённую систему ЮKassa.",
  },
  {
    q: "Могу ли я отменить подписку?",
    a: "Подписка не продлевается автоматически. По окончании оплаченного периода можно оформить заново. Возврат возможен в течение 14 дней, если вы не использовали платные функции.",
  },
];
