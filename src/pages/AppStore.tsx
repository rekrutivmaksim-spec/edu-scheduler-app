...
const FAQ = [
  {
    ...
    a: "Да! Базовые функции полностью бесплатны: расписание, задачи, зачётная книжка и 3 вопроса ИИ-ассистенту в день. Premium открывает безлимитный доступ.",
  },
  {
  ...
  },
  {
    ...
    a: "Подписка не продлевается автоматически — вы платите один раз за выбранный период. Возврат возможен в течение 14 дней.",
  },
];
