...
const FAQ = [
  {
    ...
    a: "Да! Базовые функции полностью бесплатны: расписание, задачи, зачётная книжка и вопросы ИИ-ассистенту каждый день. Premium открывает 20 вопросов в день и расширенные функции.",
  },
  {
