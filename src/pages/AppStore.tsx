...
const FAQ = [
  {
    ...
    a: "Да! Базовые функции полностью бесплатны: расписание, задачи, зачётная книжка и 10 вопросов ИИ-ассистенту в день. Premium открывает безлимитный доступ.",
  },
  {
  ...
  },
  {
    ...
    a: "Подписка продлевается автоматически. Отключить автопродление можно в любой момент в разделе «Подписка». Возврат возможен в течение 14 дней.",
  },
];
