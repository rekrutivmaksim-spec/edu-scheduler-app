        ...
        <Card className="p-8 md:p-12 bg-white shadow-xl">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Безлимитные вопросы к ИИ-ассистенту (бесплатно: от 10 до 3 в день с плавным понижением)</li>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Оплата через ЮKassa — безопасная система платежей</li>
                <li>Подписка не продлевается автоматически. По окончании срока можно оформить заново</li>
