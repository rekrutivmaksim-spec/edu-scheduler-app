        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mt-4 sm:mt-6 mb-4 sm:mb-6">
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-base sm:text-xl font-bold text-gray-800 mb-0.5 sm:mb-1 truncate">Умные Карточки</h3>
                <p className="text-xs sm:text-sm text-gray-600">ИИ создает карточки для быстрого запоминания</p>
              </div>
