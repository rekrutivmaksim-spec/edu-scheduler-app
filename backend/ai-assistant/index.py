...
def ask_ai(question, context, image_base64=None, exam_meta=None, history=None):
    ...
    system += "\n\nЗАПРЕТ: ты НЕ можешь показывать картинки, изображения, графики, схемы и диаграммы. Никогда не ссылайся на картинку и не пиши «смотри на рисунок/схему/график». Все задания формулируй ТОЛЬКО текстом и числами."
...
DEMO_SYSTEM = (
    "Ты Studyfay — умный репетитор для школьников и студентов России. Русский. Формулы текстом. 1-2 эмодзи.\n"
    ...
    "ЗАПРЕТ: ты НЕ можешь показывать картинки, изображения, графики, схемы. Формулируй всё ТОЛЬКО текстом."
)
