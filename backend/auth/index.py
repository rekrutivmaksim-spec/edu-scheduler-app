        ...
        # POST /delete_account - Удаление аккаунта
            ...
            try:
                with conn.cursor(cursor_factory=RealDictCursor) as cur:
                    ...
                    # Удаляем все данные пользователя (полная очистка)
                    uid = user['id']
                    cur.execute("DELETE FROM chat_messages WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM chat_sessions WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM document_chunks WHERE material_id IN (SELECT id FROM materials WHERE user_id = %s)", (uid,))
                    cur.execute("DELETE FROM materials WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM flashcard_progress WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM flashcards WHERE set_id IN (SELECT id FROM flashcard_sets WHERE user_id = %s)", (uid,))
                    cur.execute("DELETE FROM flashcard_sets WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM grades WHERE subject_id IN (SELECT id FROM grade_subjects WHERE user_id = %s)", (uid,))
                    cur.execute("DELETE FROM grade_subjects WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM notifications WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM notification_settings WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM push_subscriptions WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM payments WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM question_packs WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM seasonal_subscriptions WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM pomodoro_sessions WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM exam_predictions WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM daily_quests WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM daily_activity WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM user_achievements WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM streak_freeze_log WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM streak_reward_claims WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM user_streak_rewards WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM user_streaks WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM smart_suggestions WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM study_plan_days WHERE plan_id IN (SELECT id FROM study_plans WHERE user_id = %s)", (uid,))
                    cur.execute("DELETE FROM study_plans WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM group_tasks WHERE group_id IN (SELECT id FROM study_groups WHERE created_by = %s)", (uid,))
                    cur.execute("DELETE FROM group_schedule WHERE group_id IN (SELECT id FROM study_groups WHERE created_by = %s)", (uid,))
                    cur.execute("DELETE FROM study_group_members WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM study_groups WHERE created_by = %s", (uid,))
                    cur.execute("DELETE FROM schedule_subscribers WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM shared_schedules WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM referral_invites WHERE referrer_id = %s OR referred_id = %s", (uid, uid))
                    cur.execute("DELETE FROM oauth_tokens WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM sms_codes WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM task_notifications WHERE task_id IN (SELECT id FROM tasks WHERE user_id = %s)", (uid,))
                    cur.execute("DELETE FROM tasks WHERE user_id = %s", (uid,))
                    cur.execute("DELETE FROM schedule WHERE user_id = %s", (uid,))
